      ...
      <Header
        ...
        centerComponent={
          <Text style={styles.headerTitleStyle}>
            {language.ride_details_page_title}
          </Text>
        }
        ...
        <View style={styles.rideDesc}>
          <View style={styles.userDesc}>
            ...
            <View style={styles.userView}>
              ...
              {paramData && paramData.driver_name != "" ? (
                <Text style={styles.personStyle}>{paramData.driver_name}</Text>
              ) : null}
              {paramData && paramData.rating > 0 ? (
                <View style={styles.personTextView}>
                  {/*My rating to driver */}
                  <Text style={styles.ratingText}>
                    {language.you_rated_text}
                  </Text>
                  <Rating
                    showRating
                    type="star"
          ...
          {paramData && paramData.carType ? (
            <View style={[styles.userDesc, styles.avatarView]}>
              ...
              />
              <View style={styles.userView}>
                <Text style={styles.carNoStyle}>
                  {paramData.vehicle_number ? (
                    paramData.vehicle_number
                  ) : (
                    <Text> {language.car_no_not_found}</Text>
                  )}
                </Text>
                <Text style={styles.carNoStyleSubText}>
                  {paramData.carType}
                </Text>
              </View>
            </View>
