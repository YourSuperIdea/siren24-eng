            ...
            <Button
              ...
              onPress={() => {
                role == "rider"
                  ...
                  : Alert.alert(language.alert, language.cancel_confirm, [
                      {
                      ...
                      },
                      {
                        ...
                        onPress: () =>
                          dispatch(
                            cancelBooking({
                              booking: curBooking,
                              reason: language.driver_cancelled_booking,
                            })
                          ),
                      },
                    ]);
            ...
            <View style={styles.alertContainer}>
              ...
              <View style={styles.msgContainer}>
                <Text style={styles.cancelMsgText}>
                  {language.cancel_messege1} {bookingId}{" "}
                  {language.cancel_messege2}{" "}
                </Text>
              </View>
            ...
            <View style={styles.cancelContainer}>
              <View style={styles.cancelReasonContainer}>
                <Text style={styles.cancelReasonText}>
                  {language.cancel_reason_modal_title}
                </Text>
              </View>
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.mapcontainer}>
        ...
        >
          <Icon name="ios-call" type="ionicon" size={30} color={colors.WHITE} />
        </TouchableOpacity>
      </View>
      <View style={styles.bottomContainer}>
        <View style={styles.otpContainer}>
          <Text style={styles.cabText}>
            ...
            <Text style={styles.cabBoldText}>
              {curBooking && curBooking.status
                ? language[curBooking.status]
                : null}{" "}
              {curBooking && curBooking.status == "ACCEPTED"
                ? "( " + arrivalTime + " " + language.mins + " )"
                : ""}
            </Text>
          </Text>
          {role == "rider" ? (
        ...
        <View style={styles.cabDetailsContainer}>
          {curBooking && curBooking.status == "NEW" ? (
            <ImageBackground
              source={require("../../assets/images/car-moving.gif")}
              resizeMode="stretch"
              style={{
                flex: 1,
                width: width,
