    ...
    return (
      ...
      >
        <Header
          ...
          centerComponent={
            <Text style={styles.headerTitleStyle}>{language.your_promo}</Text>
          }
  ...
  return (
    <View style={styles.mainView}>
      <Header
        ...
        centerComponent={
          <Text style={styles.headerTitleStyle}>{language.payment}</Text>
        }
        containerStyle={styles.headerStyle}
        innerContainerStyles={{ marginLeft: 10, marginRight: 10 }}
      />
            ...
            >
              ...
              >
                ...
                {payDetails.payableAmmount
                  ? parseFloat(payDetails.payableAmmount).toFixed(2)
                  : 0.0}
              </Text>
            </View>
          ) : null}
            ...
            {providers ? (
              ...
              >
                <Text style={styles.buttonTitle}>
                  {userdata && userdata.usertype == "rider"
                    ? language.payWithCard
                    : language.request_payment}
                </Text>
              </TouchableOpacity>
            ) : null}
          </View>
