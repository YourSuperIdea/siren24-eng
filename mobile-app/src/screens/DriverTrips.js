...
export default function DriverTrips(props) {
  ...
  const onPressAccept = (item) => {
    ...
    if (wallet_balance >= 0) {
      if (wallet_balance == 0) {
        Alert.alert(language.alert, language.wallet_balance_zero);
      }
      ...
      Alert.alert(language.alert, language.wallet_balance_negative);
    }
  };
  ...
  return (
    <View style={styles.mainViewStyle}>
      <Header
        ...
        centerComponent={
          <Text style={styles.headerTitleStyle}>{language.task_list}</Text>
        }
          ...
          >
            ...
            <View>
              <Text style={styles.no_driver_style}>
                ...
                auth.info.profile &&
                auth.info.profile.driverActiveStatus
                  ? language.rider_not_here
                  : language.service_off}
              </Text>
            </View>
          </View>
        }
              ...
              <View style={styles.mapDetails}>
                <View style={styles.dateView}>
                  <Text style={styles.listDate}>
                    {new Date(item.tripdate).toLocaleString(dateStyle)}
                  </Text>
                </View>
                ...
                <View style={styles.estimateView}>
                  <Text style={styles.listEstimate}>
                    {item.estimateDistance
                      ? parseFloat(item.estimateDistance).toFixed(2)
                      : 0}{" "}
