  ...
  return (
    <View style={styles.mainViewStyle}>
      <Header
        ...
        centerComponent={
          <Text style={styles.headerTitleStyle}>{language.receipt}</Text>
        }
        rightComponent={
          <Text
      ...
      <View style={styles.dateViewStyle}>
        <Text style={styles.dateViewTextStyle}>
          {booking && booking.tripdate
            ? new Date(booking.tripdate).toLocaleString(dateStyle)
            : null}
        </Text>
      </View>
        ...
        <Text style={styles.rateViewTextStyle}>
          ...
          {booking
            ? booking.customer_paid > 0
              ? parseFloat(booking.customer_paid).toFixed(2)
              : 0
            : null}
        </Text>
      </View>
      ...
      <View style={styles.tripMainView}>
        <View
          style={{ flex: 3.2, justifyContent: "center", alignItems: "center" }}
        >
