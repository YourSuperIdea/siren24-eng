...
export default function AppCommon({ children }) {
  ...
  const GetOneTimeLocation = async () => {
    ...
    Alert.alert(language.alert, "This app collects location data to find nearest driver you & Locate you in your trip even when the app is closed or not in use.")
    if (status === 'granted') {
      try {
