...
export default function CarTypes() {
  ...
  const columns = [
    ...
    { title: language.base_distance, field: 'base_distance', type: 'numeric' },
    { title: language.short_range_rate, field: 'short_range_rate', type: 'numeric' },
    { title: language.long_range_rate, field: 'long_range_rate', type: 'numeric' },
    { title: language.range_divider, field: 'range_divider', type: 'numeric' },
